        ...
        <div className="absolute py-[16px] px-[16px] md:py-[48px] md:px-[64px] w-screen min-w-screen">
            <div className="flex flex-wrap justify-between items-center text-gray-200 gap-[64px] text-[24px] md:text-[18px] font-medium">
                ...
                <div className="flex flex-grow justify-end md:justify-start min-h-full">
                    ...
                    <div>
                    <div className="hidden md:flex lg:flex-grow self-end gap-[16px] ml-[16px] text-gray-300 hover:text-gray-100">
                        <Link href={AppConfig.Urls.DemoVideo as string} target="_blank" rel="noopener noreferrer">
                            Watch our demo
                        </Link>
                    </div>
                    </div>
            ...
            { showModal && 
                <div className="flex md:hidden py-[16px] px-[16px] mt-[8px] rounded-[12px] bg-primary-light w-full lg:flex-grow self-end gap-[16px] text-gray-300 hover:text-gray-100">
                    <Link href={AppConfig.Urls.DemoVideo as string} target="_blank" rel="noopener noreferrer">
                        Watch our demo
                    </Link>
                </div>

        ...
        <div className="px-[16px] flex flex-col justify-center items-center gap-[16px]">
            {!registered &&
                ...
                <form className="flex sm:hidden flex-col gap-[12px] sm:bg-primary-light rounded-full sm:gap-[4px] min-w-full sm:min-w-[396px] justify-between sm:p-[8px]" onSubmit={register}>
                    ...
                    <button type="submit" className="bg-secondary hover:scale-[95%] active:scale-[90%] text-[#EDF1F2] px-[32px] sm:px-[16px] sm:py-[8px] py-[16px] rounded-full">{ClientAppConfig.Content.PrimaryCTA}</button>
                </form>
                <form className="hidden sm:flex rounded-full sm:gap-[4px] p-[8px] min-w-full justify-between bg-primary-light" onSubmit={register}>
                    ...
                    <button type="submit" className="bg-secondary hover:scale-[95%] active:scale-[90%] text-[#EDF1F2] px-[16px] py-[4px] rounded-full">{ClientAppConfig.Content.WaitlistCTA}</button>
                </form>
                </>
            }
            { registered &&
